...
- To seed the first admin during a deploy, define `first_admin_email`, `first_admin_password`, `first_admin_firstname`, and `first_admin_lastname` in the selected Terraform tfvars file before running `make deploy`; `first_admin_nickname` is optional.
