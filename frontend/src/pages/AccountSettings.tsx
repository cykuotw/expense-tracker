...
function PasswordValidationMessage({
    ...
    return (
        ...
        >
            {validation ? (
                <p
                    className={`flex items-center gap-1.5 text-xs leading-5 ${validation.valid ? "text-success" : "text-destructive"}`}
                >
                    <svg
                        viewBox="0 0 24 24"
            ...
            <div className="page-shell">
                <div className="page-container">
                    <div className="panel-card rounded-[2rem] border-destructive/30 p-6" role="alert">
                        <p className="text-destructive">{loadError || "Unable to load account settings"}</p>
                    ...
                    <section className="panel-card rounded-[2rem] p-5 sm:p-7" aria-labelledby="profile-heading">
                        ...
                        <form className="mt-6 space-y-5" onSubmit={updateProfile}>
                            ...
                            <div>
                                ...
                                />
                                <span id="email-help" className="mt-2 block text-xs leading-5 text-foreground/60">
                            ...
                            <button
                                type="submit"
                                className="ui-button ui-button-primary min-h-11 w-full sm:w-auto"
                                disabled={savingProfile || !isProfileDirty}
                            >
                                {savingProfile ? <span className="ui-spinner ui-spinner-sm" /> : null}
                    ...
                    <section className="panel-card rounded-[2rem] p-5 sm:p-7" aria-labelledby="security-heading">
                        ...
                        {account.passwordChangeAllowed ? (
                            <>
                                ...
                                <form className="mt-6 space-y-5" onSubmit={changePassword}>
                                            ...
                                            <div key={field}>
                                                ...
                                                <div className="relative mt-2">
                                                    <input
                                                        ...
                                                        className="ui-input-shell min-h-11 w-full bg-background pr-20"
                                                    ...
                                                    <button
                                                        type="button"
                                                        className="ui-button ui-button-ghost absolute inset-y-0 right-0 min-h-11 min-w-16 rounded-l-none px-3 text-xs"
                                    ...
                                    <p id="password-guidance" className="text-xs leading-5 text-foreground/60">
                                    ...
                                    >
                                        {savingPassword ? <span className="ui-spinner ui-spinner-sm" /> : null}
                            ...
                            <div className="mt-5 rounded-2xl border border-border bg-muted/60 p-4">
                                <div className="font-medium text-foreground">Managed by Google</div>
                                <p className="mt-2 text-sm leading-6 text-foreground/65">
                        ...
                        <div className="mt-6 border-t border-border pt-5">
                            <div className="flex items-center justify-between gap-4">
                                ...
                                <span className={`ui-badge ${account.googleConnected ? "ui-badge-success" : "ui-badge-ghost"}`}>
                              ...
                              account.passwordChangeAllowed ? (
                                <div className="mt-3">
                                    ...
                                    {!googleLinkExpanded ? (
                                        <button
                                            type="button"
                                            className="ui-button ui-button-outline mt-4 min-h-11 w-full"
                                            aria-expanded="false"
                                        ...
                                        <div
                                            ...
                                            className="mt-4 rounded-2xl border border-border bg-muted/50 p-4"
                                            role="region"
                                        ...
                                        >
                                            ...
                                            <button
                                                type="button"
                                                className="ui-button ui-button-ghost mt-2 min-h-11 w-full"
                                                disabled={linkingGoogle}
